/*
  ...
  The following steps are needed for a successful build:
    1) Add libraries "TFT_eSPI" and "Button2" to your ArduinoIDE.
    2) Select the board "ESP32 Dev Module" under Tools->Board and set the proper COM port.
    3) Go to the folder holding TFT_eSPI, open file User_Setup_Select.h and 
       a) comment out the line #include <User_Setup.h>
       b) uncomment the line // #include <User_Setups/Setup25_TTGO_T_Display.h>

  The build will produce a lot of warnings but be successful though.
