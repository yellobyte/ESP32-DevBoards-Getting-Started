/*
  ...
  Test of YD-ESP32-S3_DevBoard (Manufactorer VCC-GND.COM) WiFi functionality.
  When Sketch finished: Wifi connection established...RGB-LED is green, otherwise red.
