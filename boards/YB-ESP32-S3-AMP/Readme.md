...
5) Boards with revision 3.x allow debugging programs with PlatformIO via ESP32S3's builtin 'JTAG serial debug unit'. An example is provided [here](https://github.com/yellobyte/ESP32-DevBoards-Getting-Started/tree/main/boards/YB-ESP32-S3-AMP/examples/PlatformIO/Debug-BoardRev3-via-builtin-JTAG). 
