...
All variants provide **WiFi**, **RJ45 Ethernet connector**, an Ethernet PHY bridge chip **Wiznet W5500** and **two microUSB connectors** for software upload, serial output, debugging and feeding power to the board. The boards are currently available on sales platforms [eBay (Variant with 8MB Flash/8MB PSRAM)](https://www.ebay.com/itm/125966982183), [eBay (Variant with 4MB Flash)](https://www.ebay.com/itm/126265587891) and [Ricardo.ch](https://www.ricardo.ch/en/s/YB-ESP32-S3-ETH). If they are reported 'out of stock' you can email me directly to get actual delivery dates as I have them coming in regularly.
