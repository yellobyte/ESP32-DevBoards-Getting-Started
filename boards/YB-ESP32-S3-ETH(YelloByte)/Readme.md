...
All variants provide **WiFi**, **RJ45 Ethernet connector**, an Ethernet PHY bridge chip **Wiznet W5500**, two status LEDs and **two microUSB connectors** for software upload, serial output, debugging and feeding power to the board. The boards are currently available on sales platforms [eBay (Variant with 8MB Flash/8MB PSRAM)](https://www.ebay.com/itm/125966982183), [eBay (Variant with 4MB Flash)](https://www.ebay.com/itm/126570619651) and [Ricardo.ch](https://www.ricardo.ch/en/s/YB-ESP32-S3-ETH). If they are reported 'out of stock' you can [email](mailto:yellobyte@bluewin.ch) me to get latest availability and delivery dates.
...
The boards outline, block diagram and schematic files are all located in folder [doc](https://github.com/yellobyte/ESP32-DevBoards-Getting-Started/tree/main/boards/YB-ESP32-S3-ETH(YelloByte)/doc), together with data sheets for Espressif's MCU ESP32-S3 and the ESP32-S3-WROOM-1(U) modules.
