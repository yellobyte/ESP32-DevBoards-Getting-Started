...
void setup() {
  ...
  Serial.println();
  Serial.println("ESP32-CAM-MB test program started:");
  ...
  Serial.println("");
  Serial.print("WiFi connected. ESP32-CAM-MB board IP: ");
  ...
  config.xclk_freq_hz = 20000000;     // can be set to various frequencies if problems with stream
